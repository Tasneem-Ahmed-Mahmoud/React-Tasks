...
export default function Post({ post }) {
    ...
    return (
            ...
            <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                {/* body */}
                <CardBody image={post.image} body={post.body} commentsLength={postComments.length} id={post._id} setPostComments={setPostComments} />
                {/* footer */}
                {postComments.length &&
                    <CardFooter comment={postComments[0]} />
